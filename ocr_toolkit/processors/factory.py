...
class ProcessorFactory:
    ...
    def __init__(self):
        ...
        self._ocr_processor_class: type[FileProcessorBase] | None = None
    ...
    def create_ocr_processor(self, **kwargs) -> FileProcessorBase | None:
        """
    ...
    def create_processor(self, processor_type: str, **kwargs) -> FileProcessorBase | None:
        """
    ...
    def get_processor_for_file(self, file_path: str, **kwargs) -> FileProcessorBase | None:
        """
