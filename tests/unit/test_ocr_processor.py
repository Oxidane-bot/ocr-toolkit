...
class TestOCRProcessor:
    ...
    def test_init_with_cnocr_enabled(self):
        ...
        with patch('ocr_toolkit.processors.ocr_processor.OCRProcessor._initialize_cnocr_handler') as mock_init:
    ...
    def test_init_with_cnocr_disabled(self):
        ...
        assert processor.cnocr_handler is None
    ...
    def test_initialize_cnocr_success(self):
        ...
        with patch('shutil.which', return_value='/path/to/huggingface-cli'), \
            ...
            assert processor.use_cnocr == True
            assert processor.cnocr_handler is not None
            assert processor.cnocr_handler.is_available() == True
